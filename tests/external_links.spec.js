...
test("that each index external link goes to the right place", async ({
  context,
  page,
}) => {
...
test("that each footer external link goes to the right place", async ({
  context,
  page,
}) => {
  await testTargetBlank(
  ...
  await testTargetBlank(
    ...
    "/",
    "Mastodon",
    "https://fosstodon.org/@sethrothschild"
  );
  await testTargetBlank(
    context,
    page,
...
test("that each programming external link goes to the right place", async ({
  context,
  page,
}) => {
  await testTargetBlank(
